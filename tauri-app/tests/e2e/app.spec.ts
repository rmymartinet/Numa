...
test.describe('Numa Application E2E Tests', () => {
  ...
  test('should load the main HUD interface', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="toggle-panel-button"]')).toBeVisible();
  ...
  test('should toggle panel visibility', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="dropdown-panel"]')).not.toBeVisible();
  ...
  test('should navigate between tabs in panel', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="personalize-content"]')).not.toBeVisible();
    ...
    await expect(page.locator('[data-testid="personalize-content"]')).toBeVisible();
    await expect(page.locator('[data-testid="activity-content"]')).not.toBeVisible();
  ...
  test('should handle accessibility features', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="capture-button"]')).toHaveAttribute('aria-label');
    await expect(page.locator('[data-testid="toggle-panel-button"]')).toHaveAttribute('aria-label');
    ...
    await page.keyboard.press('Tab');
    await expect(page.locator('[data-testid="toggle-panel-button"]')).toBeFocused();
  });
