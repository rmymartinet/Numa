...
const SettingsContent: React.FC = () => {
  const [activeSettingsTab, setActiveSettingsTab] = React.useState<'settings' | 'app' | 'profile' | 'security' | 'billing'>('settings');
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-700 dark:text-gray-300">Auto-save preferences</span>
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <h4 className="font-medium text-blue-900 dark:text-blue-100">Free Plan</h4>
